...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Jabatan',
            fields=[
                ('jabatan_id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('nama_jabatan', models.CharField(max_length=255)),
                ('grup_auth', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auth.group')),
            ],
        ),
        migrations.CreateModel(
            name='Kategori',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jabatan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.jabatan')),
